<template>
  ...
  >
    <div style="position: absolute; top: -28px; right: 0" @click="saveFlow">
      保存
    </div>
...
import { defaultLogo, eventNodeMap } from '../util/typeMap'
...
export default {
  ...
  data() {
    return {
      ...
      loading: true,
      initData:
        '<?xml version="1.0" encoding="UTF-8"?>\n<definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:flowable="http://flowable.org/bpmn" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:omgdc="http://www.omg.org/spec/DD/20100524/DC" xmlns:omgdi="http://www.omg.org/spec/DD/20100524/DI" xmlns:g6="http://bpmn.io/schema/bpmn/g6/1.0" xmlns:activiti="http://activiti.org/bpmn" typeLanguage="http://www.w3.org/2001/XMLSchema" expressionLanguage="http://www.w3.org/1999/XPath" targetNamespace="http://www.activiti.org/processdef">  <process id="flow63847_1724147036223" name="流程">    <startEvent id="startEvent1"/>    <endEvent id="endEvent1"/>    <userTask id="userTask325035" name="未命名步骤"/>    <userTask id="userTask325167" name="第二步骤"/>    <sequenceFlow id="startEvent1-userTask325035" sourceRef="startEvent1" targetRef="userTask325035">    </sequenceFlow>    <sequenceFlow id="userTask325035-userTask325167" sourceRef="userTask325035" targetRef="userTask325167">    </sequenceFlow>    <sequenceFlow id="userTask325167-endEvent1" sourceRef="userTask325167" targetRef="endEvent1">    </sequenceFlow>  </process>  <bpmndi:BPMNDiagram id="BPMNDiagram_flow">    <bpmndi:BPMNPlane bpmnElement="flow" id="BPMNPlane_flow">      <bpmndi:BPMNShape bpmnElement="startEvent1" id="BPMNShape_startEvent1" g6:conditionType="exclusive">        <omgdc:Bounds width="68" height="68" x="100" y="344"/>      </bpmndi:BPMNShape>      <bpmndi:BPMNShape bpmnElement="endEvent1" id="BPMNShape_endEvent1" g6:conditionType="exclusive">        <omgdc:Bounds width="68" height="68" x="841" y="343"/>      </bpmndi:BPMNShape>      <bpmndi:BPMNShape bpmnElement="userTask325035" id="BPMNShape_userTask325035" g6:conditionType="inclusive" g6:isRepeat="false" g6:isAutoStep="false">        <omgdc:Bounds width="136" height="58" x="270" y="344"/>      </bpmndi:BPMNShape>      <bpmndi:BPMNShape bpmnElement="userTask325167" id="BPMNShape_userTask325167" g6:conditionType="inclusive" g6:isRepeat="false" g6:isAutoStep="false">        <omgdc:Bounds width="136" height="58" x="470.5" y="343.5"/>      </bpmndi:BPMNShape>      <bpmndi:BPMNEdge bpmnElement="startEvent1-userTask325035" sourceElement="BPMNShape_startEvent1" targetElement="BPMNShape_userTask325035" g6:branchTaskColor="" g6:isAutoBack="" id="BPMNEdge_startEvent1-userTask325035">        <omgdi:waypoint x="135" y="344"/>        <omgdi:waypoint x="202" y="344"/>      </bpmndi:BPMNEdge>      <bpmndi:BPMNEdge bpmnElement="userTask325035-userTask325167" sourceElement="BPMNShape_userTask325035" targetElement="BPMNShape_userTask325167" g6:branchTaskColor="" g6:isAutoBack="" id="BPMNEdge_userTask325035-userTask325167">        <omgdi:waypoint x="338" y="344"/>        <omgdi:waypoint x="402.5" y="343.5"/>      </bpmndi:BPMNEdge>      <bpmndi:BPMNEdge bpmnElement="userTask325167-endEvent1" sourceElement="BPMNShape_userTask325167" targetElement="BPMNShape_endEvent1" g6:branchTaskColor="" g6:isAutoBack="" id="BPMNEdge_userTask325167-endEvent1">        <omgdi:waypoint x="538.5" y="343.5"/>        <omgdi:waypoint x="806" y="343"/>      </bpmndi:BPMNEdge>    </bpmndi:BPMNPlane>  </bpmndi:BPMNDiagram></definitions>'
    }
  },
  async mounted() {
    this.loading = true
  ...
  methods: {
    saveFlow() {
      ...
      // const a = this.lf.adapterOut(this.lf.getGraphRawData())

      // console.log('aaaa==', a)
      // const xmlResult = this.lf.adapterIn(this.lf.getGraphRawData())
      // console.log('xmlResult==', xmlResult)
      console.log('saveData==', this.lf.getGraphData())

      console.log('getGraphRawData==', this.lf.getGraphRawData())
    },
    // 节点拖拽到画布时的操作
    onDrop(e) {
    ...
    initCanvas() {
      ...
      this.lf = new LogicFlow({
        ...
        // adjustEdge: false,
        // BPMNAdapter,BpmnXmlAdapter,BpmnElement
        plugins: [MiniMap, SelectionSelect, Menu, Dagre, Popover, BPMNAdapter],
        keyboard: {
          enabled: true,
          shortcuts: [
            {
      ...
      // const transData = this.lf.adapterIn(graphData)
      // console.log('transData==', transData)
      this.lf.adapterIn = undefined
    ...
    initEvents() {
      ...
      this.lf.on('blank:click', () => {
        ...
        this.context.eventCenter.emit(EDITOR_EVENT.CANVAS_MODEL_ACTIVATED, null)
      })
    ...
    getGraphDataFromContext() {
      ...
      return {
        nodes: [
          ...
          {
            id: '2',
            type: event.type, // 节点类型为圆形
            x: 300, // 节点的 x 坐标
            y: 100, // 节点的 y 坐标
            properties: {
              componentId: 'page_end',
              componentName: 'pageEnd',
              name: '结束',
              logo: eventNodeMap.pageInit.logo
            }
          }
    ...
    handleSubmit(type, model) {
      ...
      if (type === 'condition') {
        this.graph.insertNode(model, 'common-node', {
